...
const ProductCard = ({ product }: ProductCardProps) => {
  return (
    <div className="md:w-79.5 md:h-121.5 w-full h-75.25">
      ...
      <div className="flex flex-col gap-4 mt-4">
        ...
        <Link href={`/product/${product.id}`} className="bg-[#232321] rounded-xl flex items-center justify-center uppercase font-medium text-white font-rubik h-10 md:h-12">
